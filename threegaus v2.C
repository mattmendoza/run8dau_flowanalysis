...
TCanvas * fit_m2_threepeak(TH1D * h,int whichtof, int centbin, int charge, int idphi, float ptrange[])
{
  ...
  h->Fit("fun3","RQN");
    ...
    for(int ipar=0; ipar<6; ipar++){
      ...
      if(ipar==3) { fun->SetParLimits(ipar, fun1->GetParameter(0)/3,fun1->GetParameter(0)*2/3); }//kaon height
      ...
      if(ipar==5) { fun->SetParLimits(ipar, fun1->GetParameter(2)/3,fun1->GetParameter(2)/2); }  //kaon width
    } //par loop
    ...
    funbulk->FixParameter(4, fun3->GetParameter(1));  //prot mean
    ...
    fun_proton->SetParameter(2,funbulk->GetParameter(5)+funbulk->GetParameter(2));
    fun_proton->SetParError(2, funbulk->GetParError(5)); 
    ...
    //h->Fit("funmerge","RQN+"); //unquiet this later
      ...
      funmerge->FixParameter(0, fun_pion->GetParameter(0)  ); //pion height
      funmerge->FixParameter(1, fun_pion->GetParameter(1)  ); //pion mean
      funmerge->FixParameter(2, fun_pion->GetParameter(2)  ); //pion width
      funmerge->FixParameter(3, fun_kaon->GetParameter(0)  ); //kaon height
      funmerge->FixParameter(4, fun_kaon->GetParameter(1)  ); //kaon mean
      funmerge->FixParameter(5, fun_kaon->GetParameter(2)  ); //kaon width      
      funmerge->FixParameter(6, fun_proton->GetParameter(0)); //prot height
      funmerge->FixParameter(7, fun_proton->GetParameter(1)); //prot mean
      funmerge->FixParameter(8, fun_proton->GetParameter(2));   //prot width
    ...
    //  //fun_proton->SetParError(ipar, funbulk->GetParError(ipar+3) ); 
    //  //fun_proton->SetParameter(2,   funbulk->GetParameter(5)+funbulk->GetParameter(2));
    //  //fun_proton->SetParError(2,    funbulk->GetParError(5) +funbulk->GetParError(2)); 
    //}
