...
void fitInit(int itof, int icent, int ich, int ptbin)
{
  setTuning = 0;
  //cout << "init Fits..." << endl;
  fitTuning = loadFitParams(ptbin); // flag to tell tuning function to initialize unity tuning or unique tunings for different bins
...
parstruct loadFitParams(int ptbin) {
